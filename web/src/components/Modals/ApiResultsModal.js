...
export const ApiResultsModal = ({ isOpen, setIsModalOpen, results, formData }) => {
    ...
    <div className={`results-modal ${isOpen ? 'd-flex' : 'd-none'}`} id="results-modal">
      <div className="modal-content">
        ...
        <div className="modal-body" id="api-results">
          ...
          {
            formData?.search_type === 'deep' && results?.formId && <AllStackAIDeepSearchResults isOpen={isOpen} businessName={formData?.business_name} ownerName={formData?.owner_name} domain={formData?.domain} formId={results?.formId} />
          }
